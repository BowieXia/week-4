...
console.log('List of baked goods', printMenu(bakedGoods));
...
var query5 = _.filter(bakedGoods,function(object){
    return object.price > 4;
});
...
var query6 = _.sortBy(bakedGoods, function(object){
...
var query7 = _.groupBy(bakedGoods, function(object){
    return object.type;
});
